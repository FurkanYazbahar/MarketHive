namespace Ordering.Infrastructure.Data.Extentions
{
    internal class InitialData
    {
        public static IEnumerable<Customer> Customers =>
            new List<Customer>
            {
                Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "furkan", "furkan@gmail.com"),
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("furkan", "yazbahar", "furkan@gmail.com", "Üsküdar No:4", "Turkey", "Istanbul", "38050");
                var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

                var payment1 = Payment.Of("furkan", "5555555555554444", "12/28", "355", 1);
